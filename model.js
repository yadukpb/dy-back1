...
const userSchema = new mongoose.Schema(
  {
    ...
    testQuestionNumber: { type: Number, required: true, default: 0 },
    curentLevel: { type: String, required: true, default: "1.0" },
    totalLevels: { type: Number, required: true, default: 5 },
    isTestComplete: { type: Boolean, required: true, default: false },
    NoOfQuestions: {
